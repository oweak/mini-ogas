...
from app.vault import encrypt_vault_payload, valid_api_key
...
def main() -> None:
    ...
    payload = {
        ...
        "base_url": os.getenv(
            "MINIOGAS_AI_BASE_URL", "https://api.deepseek.com"
        ).strip()
        or "https://api.deepseek.com",
        "api_key": api_key,
    }
    path = Path(os.getenv("MINIOGAS_AI_VAULT_PATH", "secrets/ai-vault.json"))
